 ...
 * @return array
 */
class AppHelpController extends MerchantController {
...
//                'only' => ['single'],//指定控制器应用到哪些动作
    ...
    public function actionList() {
        if (yii::$app->request->isGet) {
            ...
            $params['system_app_access_help.merchant_id'] = yii::$app->session['uid'];
            ...
            $params['system_app_access_help.key'] = $params['key'];
            unset($params['key']);
            $params['field'] = "system_app_access_help.*,system_app_access_help_category.name  as category_name ";
            $params['join'][] = ['inner join', 'system_app_access_help_category', 'system_app_access_help_category.id = system_app_access_help.category_id'];
    ...
    public function actionAdd() {
        if (yii::$app->request->isPost) {
            ...
            $must = ['title', 'key', 'content', 'category_id'];
            ...
            if ($array['status'] == 200){
                ...
                $operationRecordData['module_name'] = '常见问题列表';
