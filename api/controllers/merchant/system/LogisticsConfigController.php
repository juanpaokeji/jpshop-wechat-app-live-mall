...
use app\models\system\SystemLogisticsConfigModel;
use yii;
use yii\web\MerchantController;

class LogisticsConfigController extends MerchantController
{
    ...
    public function actionAdd()
    {
        if (yii::$app->request->isPost) {
            ...
            $model = new SystemLogisticsConfigModel();
            //关闭所有物流api配置，只开启当前编辑的
            $data['status'] = 0;
