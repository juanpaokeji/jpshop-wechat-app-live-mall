    ...
    public function actionAdd()
    {
        if (yii::$app->request->isPost) {
            ...
            $data = array(
                ...
                'balance_sn' => order_sn(),
                'order_sn' => 0,
                'fee' => round((float)$params['money'] * ((float)$config['data']['withdraw_fee_ratio'] / 100),2),
                'money' => (float)$params['money'],
                'remain_money' => round((float)$params['money'] - ((float)$params['money'] * ((float)$config['data']['withdraw_fee_ratio'] / 100)),2),
                'content' => $content,
