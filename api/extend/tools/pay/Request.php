...
use tools\pay\Exception\ConnectionErrorException;

include __DIR__ . DIRECTORY_SEPARATOR . 'Http.php';
include __DIR__ . DIRECTORY_SEPARATOR . 'Response.php';
include __DIR__ . DIRECTORY_SEPARATOR . 'Exception' . DIRECTORY_SEPARATOR .'ConnectionErrorException.php';
    ...
    public function buildResponse($result) {
        if ($result === false) {
            if ($curlErrorNumber = curl_errno($this->_ch)) {
                ...
                throw new \Exception('Unable to connect to "'.$this->uri.'": ' . $curlErrorNumber . ' ' . $curlErrorString);
            }
