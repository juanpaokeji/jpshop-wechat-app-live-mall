 ...
 * @Bean()
 */
class CategoryModel extends TableModel {
    ...
    public function findall($params) {
        ...
        try {
            ...
            $params['table'] = "system_app_category";
    ...
    public function find($params) {
        ...
        //数据库操作
        try {
            $app = $table->tableSingle('system_app_category', ['id' => $params['id'], 'delete_time is null' => null]);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
    ...
    public function add($params) {
        ...
        $table = new TableModel();
        try {
            $res = $table->tableAdd('system_app_category', $data);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
        if (!$res) {
    ...
    public function delete($params) {
        ...
        $table = new TableModel();
        try {
            $res = $table->tableUpdate('system_app_category', $params, $where);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
        if (!$res) {
