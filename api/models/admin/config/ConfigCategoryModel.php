 ...
 * @Bean()
 */
class ConfigCategoryModel extends TableModel {
    ...
    public function findall($params) {
        ...
        try {
            ...
            $params['table'] = "system_config_category";
    ...
    public function find($params) {
        ...
        //数据库操作
        try {
            $app = $table->tableSingle('system_config_category', ['id' => $params['id'], 'delete_time is null' => null]);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
    ...
    public function add($params) {
        ...
        $res = $table->tableAdd('system_config_category', $params);
        try {
    ...
    public function delete($params) {
        ...
        $table = new TableModel();
        try {
            $res = $table->tableUpdate('system_config_category', $params, $where);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
        if (!$res) {
