 ...
 * @Bean()
 */
class SystemAccessModel extends TableModel {
    ...
    public function findall($params) {
        ...
        try {
            ...
            $params['table'] = "system_auth_group_access";
    ...
    public function find($params) {
        ...
        $params['delete_time is null'] = null;
        try {
            $app = $table->tableSingle('system_auth_group_access', $params);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
    ...
    public function add($params) {
        ...
        try {
            $res = $table->tableAdd('system_auth_group_access', $params);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
        if (!$res) {
    ...
    public function delete($params) {
        ...
        $table = new TableModel();
        try {
            $res = $table->tableUpdate('system_auth_group_access', $params, $where);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
        if (!$res) {
    ...
    public function update($params) {
        //where 条件设置
        $where = ['uid' => $params['uid'], 'type' => $params['type']];
        unset($params['id']);
        unset($params['type']);
        //params 参数值设置
        ...
        $table = new TableModel();
        try {
            $res = $table->tableUpdate('system_auth_access', $params, $where);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
