 ...
 * @Bean()
 */
class UserAccessModel extends TableModel {
    ...
    public function findall($params) {
        ...
        try {
            ...
            $params['table'] = "forum_user_access";
    ...
    public function find($params) {
        ...
        //数据库操作
        try {
            $app = $table->tableSingle('forum_user_access', ['union_id' => $params['union_id'], 'delete_time is null' => null]);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
    ...
    public function add($params) {
        ...
        //数据库操作
        $table = new TableModel();
        $res = $table->tableAdd('forum_user_access', $params);
        try {
    ...
    public function delete($params) {
        ...
        $table = new TableModel();
        try {
            $res = $table->tableUpdate('forum_user_access', $params, $where);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
        if (!$res) {
