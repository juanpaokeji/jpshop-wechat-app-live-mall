...
namespace app\models\merchant\distribution;

use app\models\common\CommonModel;

/**
 * Class SuperModel
 * @package app\models\distribution
 */
class SuperModel extends CommonModel {

    /**
     * shop_super_user 超级会员
     * @return string
     */
    public static function tableName() {
        return 'shop_super_user';
    }
