...
namespace app\models\merchant\pay;
 ...
 * @Bean()
 */
class PayModel extends TableModel {

    public $table = "system_pay";
    ...
    public function find($params) {
        ...
        try {
            if (isset($params['id'])) {
                ...
                $app = $table->tableSingle($this->table, ['order_id' => $params['order_id'], 'delete_time is null' => null]);
            }
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
