...
namespace app\models\merchant\picture;

use app\models\common\CommonModel;

/**
 * Class PictureGroupModel
 * @package app\models\picture
 */
class PictureGroupModel extends CommonModel {
    ...
    public function do_select($params) {
        ...
        if (isset($params['searchName'])) {
            ...
            $params['like'] = ['name', "{$params['searchName']}"];
