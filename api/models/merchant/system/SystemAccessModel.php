...
class SystemAccess extends CommonController {
    ...
    public function actionList() {
        if (yii::$app->request->getIsGet()) {
            ...
            $app = $table->tableList('shop_auth_group_access', ['delete_time is null' => null]);
            foreach ($app as $a) {
    ...
    public function actionSingle() {
        if (yii::$app->request->getIsGet()) {
            ...
            $app = $table->tableSingle('shop_auth_group_access', ['id' => $params['id'], 'delete_time is null' => null]);
    ...
    public function actionAdd() {
        if (yii::$app->request->getIsPost()) {
            ...
            $table = new TableModel();
            $res = $table->tableAdd('shop_auth_group_access', $data);
    ...
    public function actionDelete() {
        if (yii::$app->request->getIsDelete()) {
            ...
            $table = new TableModel();
            $res = $table->tableUpdate('shop_auth_group_access', $params, $where);
            if (!$res) {
                return [
                    'status' => '500',
                    'message' => '1002 删除失败',
