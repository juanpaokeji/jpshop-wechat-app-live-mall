 ...
 * @Bean()
 */
class AlipayModel extends TableModel {
    ...
    public function findall($params) {
        ...
        try {
            $app = $table->tableList('system_pay_alipay', ['delete_time is null' => null]);
        } catch (Exception $ex) {
    ...
    public function find($params) {
        ...
        //数据库操作
        try {
            $app = $table->tableSingle('system_pay_alipay', ['id' => $params['id'], 'delete_time is null' => null]);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
    ...
    public function add($params) {
        ...
        //数据库操作
        $table = new TableModel();
        $res = $table->tableAdd('system_pay_alipay', $params);
        try {
    ...
    public function delete($params) {
        ...
        $table = new TableModel();
        try {
            $res = $table->tableUpdate('system_pay_alipay', $params, $where);
        } catch (Exception $ex) {
            return result(500, '数据库操作失败');
        }
        if (!$res) {
