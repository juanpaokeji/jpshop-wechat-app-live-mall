 ...
 * @Bean()
 */
class MerchantCategoryModel extends TableModel {

    public $table = "shop_marchant_category";
    ...
    public function find($params) {
        ...
        if (array_key_exists('parent_id != 0',$params)) {
            $where['parent_id != 0'] = $params['parent_id != 0'];
        }
