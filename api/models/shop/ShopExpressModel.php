 ...
 * @Bean()
 */
class ShopExpressModel extends TableModel {

    public $table = "shop_express";
    ...
    public function findall($params) {
        ...
        try {
            ...
            $params['shop_express.delete_time is null'] = null;
            ...
            if (isset($params['searchName'])) {
                ...
                $params["system_express.name like '%{$params['searchName']}%'"] = null;
