 ...
 * @Bean()
 */
class ShopExpressTemplateDetailsModel extends TableModel {

    public $table = "shop_express_template_details";
    ...
    public function findall($params) {
        ...
        $params['shop_express_template.delete_time is null'] = null;
        $params['table'] = $this->table;
        //    $params['join'] = " inner join system_express on system_express.id = shop_express.system_express_id ";
    ...
    public function find($params) {
        ...
        if (isset($params['shop_express_template_id'])) {
            $where['shop_express_template_id'] = $params['shop_express_template_id'];
        }
    ...
    public function deleteTrue($params) {
        //where条件设置
        //  $where = ['id' => $params['id']];
        if (isset($params['merchant_id'])) {
            $where['merchant_id'] = $params['merchant_id'];
        ...
        if (isset($params['shop_express_template_id'])) {
            $where['shop_express_template_id'] = $params['shop_express_template_id'];
            unset($params['shop_express_template_id']);
        }
        //params 参数设置
