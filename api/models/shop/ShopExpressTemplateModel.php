 ...
 * @Bean()
 */
class ShopExpressTemplateModel extends TableModel {

    public $table = "shop_express_template";
    ...
    public function find($params) {
        ...
        if (gettype($app) != 'array') {
            ...
            $rs = $table->tableList(['table' => 'shop_express_template_details', 'shop_express_template_id' => $app['id']]);
            $app['details'] = $rs;
