 ...
 * @Bean()
 */
class SubOrderModel extends TableModel {
    ...
    public function find($params) {
        ...
        if (isset($params['order_sn'])) {
            $where['order_group_sn'] = $params['order_sn'];
        }
    ...
    public function update($params) {
        ...
        if (isset($params['order_group_sn'])) {
            $where['order_group_sn'] = $params['order_group_sn'];
            unset($params['order_group_sn']);
        }
        $where['delete_time is null'] = null;
        unset($params['id']);
        //params 参数值设置
