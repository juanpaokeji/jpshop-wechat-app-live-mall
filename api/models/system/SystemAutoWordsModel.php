 ...
 * @Bean()
 */
class SystemAutoWordsModel extends TableModel {

    public $table = "system_auto_words";
    ...
    public function find($params) {
        ...
        if (isset($params['searchName'])) {
            $where['searchName'] = $params['searchName'];
        }
        if (isset($params['words'])) {
            $where['words'] = $params['words'];
        }
        if (isset($params['merchant_id'])) {
            $where['merchant_id'] = $params['merchant_id'];
        }
        if (isset($params['auto_type'])) {
            $where['auto_type'] = $params['auto_type'];
        }
