 ...
 * @Bean()
 */
class SystemWxConfigModel extends TableModel {

    public $table = "system_wx_config";
    ...
    public function find($params) {
        ...
        try {
            ...
            if (isset($params['miniprogram_id'])) {
                $where['miniprogram_id'] = $params['miniprogram_id'];
                unset($params['miniprogram_id']);
            }
