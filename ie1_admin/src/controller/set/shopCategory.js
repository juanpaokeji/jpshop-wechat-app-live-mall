...
layui.define(function (exports) {
    layui.use(['table', 'jquery', 'form', 'admin', 'setter'], function () {
        ...
        var operationId;//当前操作的 id
        var add_edit_type;//新窗口打开类型
        ...
        //页面不同属性
        var url = baseUrl + "/adminShopCategory";//当前页面主要使用 url
        var cols = [//加载的表格
            {field: 'pic_url', title: '应用图片', templet: '#imgTpl', width: '20%'},
            {field: 'name', title: '类目名称', width: '20%'},
            {field: 'detail_info', title: '详细说明', width: '20%'},
        ...
        //     $.ajax({
        //         url: baseUrl + '/adminShopCategoryParent',
        //         type: "get",
        //         headers: headers,
        //         beforeSend: function () {
        //             loading = layer.load(loadType, loadShade);//显示加载图标
