...
layui.define(function (exports) {
    layui.use(['table', 'jquery', 'form', 'admin', 'setter'], function () {
        ...
        //页面不同属性
        var url = baseUrl + "/temps";//当前页面主要使用 url
        var cols = [//加载的表格
            {field: 'title', title: '模板标题', width: "15%"},
            {field: 'type', title: '短信类型', width: "15%", templet: '#typeTpl'},
            {field: 'reply', title: '审批信息', width: "15%"},
            {field: 'name', title: '模板内容', width: "20%",},
            {field: 'auditStatus', title: '审核状态', width: "10%"},
            {field: 'status', title: '启用状态', width: "10%", templet: '#statusTpl'},
            ...
            if (layEvent === 'edit') {//修改
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $("textarea[name=text]").val(res.data.name);
