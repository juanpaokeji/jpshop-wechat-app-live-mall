...
layui.define(function (exports) {
    layui.use(['table', 'jquery', 'form', 'admin', 'setter'], function () {
        ...
        //页面不同属性
        var url = baseUrl + "/vouacts";//当前页面主要使用 url
        var cols = [//加载的表格
            {field: 'act_name', title: '活动名称', width: '33%'},
            {field: 'create_time', title: '创建时间', width: '33%'},
            // {field: 'status', title: '状态', width: '10%', templet: '#statusTpl'},
            {field: 'operations', title: '操作', toolbar: '#operations', width: '34%'}
        ];
            ...
            if (layEvent === 'edit') {//修改
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        /*diy设置开始*/
                        $("input[name=act_name]").val(res.data.act_name);
