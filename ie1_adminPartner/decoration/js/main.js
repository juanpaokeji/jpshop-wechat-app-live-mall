...
var data = {
    ...
    defaultModels: [{
        ...
        details: {
            height: "",
            imgs: [{
                src: "./decoration/images/uc-banner.jpg",
                link: "link1"
            }],
            dotShow: true,
            color1: "#ff0000",
        ...
        details: {
            ...
            fontSize: '12px',
            imgs: [{
                src: "./decoration/images/icon-grid.png",
                text: "名称",
                link: ""
            }],
            color1: "#333",
        ...
        details: {
            ...
            color2: "#fff",
            imgs: [{
                src: "./decoration/images/product1.png",
                title: "标题",
                text: "内容内容",
                link: ""
            }, {
        ...
        details: {
            imgs: [{
                src: "./decoration/images/three-1.png",
                link: ""
            }, {
                src: "./decoration/images/three-2.png",
                link: ""
            }, {
                src: "./decoration/images/three-2.png",
                link: ""
        ...
        details: {
            imgs: [{
                src: "./decoration/images/four-1.png",
                link: ""
            }, {
                src: "./decoration/images/three-1.png",
                link: ""
        ...
        details: {
            ...
            opacity: .9,
            imgs: [{
                src: "./decoration/images/service.png",
                link: "link1"
            }]
        }
    }, {
        ...
        details: {
            ...
            color2: "#0080ff",
            imgs: [{
                src: "./decoration/images/sound.png"
            }]
        }
    }, {
        type: 19,
        ...
        details: {
            ...
            color2: "#fff",
            imgs: [{
                src: "./decoration/images/shop.png"
            }]
        }
    }, {
        type: 26,
        ...
        details: {
            ...
            addr: '',
            style: 1,
            lon: '119.1635674238205',
            lat: '34.5723181626876' // 拾取坐标  按钮未处理
