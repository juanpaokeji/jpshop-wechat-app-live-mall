...
layui.define(function (exports) {
    layui.use(['jquery', 'form', 'admin', 'setter', 'upload', 'laydate'], function () {
        ...
        /*diy设置开始*/
        //页面不同属性
        var url = baseUrl + "/partnerGoods";//当前页面主要使用 url
        /*diy设置结束*/
        ...
        //加载商品分组
        $.ajax({
            url: baseUrl + '/partnerCategoryTypeMini',
            type: "get",
            headers: headers,
            async: false,
            beforeSend: function () {
        ...
        // //加载区域分组
        // arr = {
        //     method: 'partnerGoodsCityGroup',//获取所有的省市区
        //     type: 'get',
        //     params: 'status=1'
        // };
        ...
        if (goods_id) {
            ...
            $.ajax({
                    ...
                    success: function (res) {
                        ...
                        //分组单独处理 类目已删除
                        var m_parent_id;
                        console.log(merchantShopCategory)
