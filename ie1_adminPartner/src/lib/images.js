...
layui.define(function (exports) {
    ...
    layui.use(['jquery', 'setter', 'admin', 'table', 'form', 'laypage'], function () {
        ...
        var ajax_method_images_group = 'partnerPictureGroup';
        ...
        function getImages(picture_group_id) {
            arr = {
                method: 'partnerPicture/' + picture_group_id,
                type: 'get',
                data: {
                    limit: limit,
                    page: tabPage
        ...
        $(document).off('click', '.images_delete_icon').on('click', '.images_delete_icon', function () {
            ...
            layer.confirm('确定要删除这张图片么?', function (index) {
                layer.close(index);
                arr = {
                    method: 'partnerMerchantGoodsPicture/' + id,
                    type: 'delete'
                };
        ...
        function doPictureUploadImagesGroup() {
            arr = {
                method: 'partnerMerchantGoodsPicture',
                type: 'post',
                data: {
        ...
        form.on('submit(group_manage)', function () {
            ...
            arr = {
                ...
                method: ajax_method_images_group,//请求的 api 接口
                cols: [cols]//加载的表格字段
            };
