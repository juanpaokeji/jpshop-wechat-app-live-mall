	...
	layui.use(['jquery', 'setter', 'admin', 'table', 'form', 'laydate'], function () {
		...
		var data = {
			...
			defaultModels: [{
				type: 1,
				edit: true,
				details: { imgs: [{ src: "./decoration/images/uc-banner.jpg", link: "link1" }], dotShow: true, color1: "#ffffff", isloop: true, color2: "#fff", boxHeight: 180, style: 1 }
			}, {
				type: 2,
				edit: true,
				...
				type: 6,
				edit: true,
				details: { style: '1', color2: "#fff", radius: 10, imgs: [{ src: "./decoration/images/bannerList.png", link: "" }] }
			}, {
				type: 7,
				edit: true,
				...
				type: 14,
				edit: true,
				details: { positionRight: 1, positionBottom: 1, opacity: .9, goTop: false, shire: true, type: 1, imgs: [{ src: "https://imgs.juanpao.com/2019%2F06%2F15%2F15605812215d049465e5868.png", link: "link1" }] }
			}, {
				type: 15,
				edit: true,
				...
				type: 18,
				edit: true,
				details: { text: '请填写公告内容', color1: "#ff0000", color2: "#fff", imgs: [{ src: window.location.origin + '/' + "./decoration/images/sound.png", text: '请填写公告内容' }] }
			}, {
				type: 19,
				edit: true,
				...
				type: 26,
				edit: true,
				details: { color1: "#333", color2: "#fff", addr: '', style: '1', lon: '119.1635674238205', lat: '34.5723181626876', logo: window.location.origin + '/' + './decoration/images/address.png' }// 拾取坐标  按钮未处理
			}, {
				type: 27,
				edit: true,
				details: { style: '1', imgs: [{ src: './decoration/images/coupons.png', link: '' }] }
			}, {
				type: 28,
				edit: true,
				details: { style: '1', show: true, type: '1' }
			}, {
				type: 29,
				edit: true,
				details: { style: '1', show: true, style: '1' }
			}, {
				type: 30,
				edit: true,
				details: { color: '#555555', textAlign: 'center', fontSize: '12px', fontWeight: '300', text: '请输入内容', top: '30', left: '' }
			}
			]
		};
		//交换数组
		...
		var vm = new Vue({
			...
			methods: {
				...
				//双击选择商品id
				linkSelectShip: function (e) {
					if (typeString == 'link') {
						obj.pageParam[obj.addId].details.imgs.forEach(function (i, index) {
							if (obj.index == index) {
								i.link = e.id || e
								i.full_price = e.full_price
								i.price = e.price
							}
						})
						console.log(obj.pageParam[obj.addId], e)
